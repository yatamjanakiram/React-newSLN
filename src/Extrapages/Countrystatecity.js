    ...
    const [city, setCity]= useState([]);
     ...
     useEffect( ()=>{
         const getcountry= async()=>{
             const rescountry= await axios("http://localhost/devopsdeveloper/country/");
     ...
     const getstate= async()=>{
         const resstate= await axios(`http://localhost/devopsdeveloper/state/getstate/${countryid}`);
...
useEffect( ()=>{
    const getcity= async()=>{   
        const rescity= await axios(`http://localhost/devopsdeveloper/city/getcity/${stateid}`);
